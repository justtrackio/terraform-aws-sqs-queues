...
| Name | Description |
|------|-------------|
| <a name="output_queue_arns"></a> [queue\_arns](#output\_queue\_arns) | SQS queue arns |
| <a name="output_queue_dead_letter_arns"></a> [queue\_dead\_letter\_arns](#output\_queue\_dead\_letter\_arns) | SQS dead letter queue arns |
| <a name="output_queue_dead_letter_ids"></a> [queue\_dead\_letter\_ids](#output\_queue\_dead\_letter\_ids) | SQS dead letter queue id |
| <a name="output_queue_dead_letter_names"></a> [queue\_dead\_letter\_names](#output\_queue\_dead\_letter\_names) | SQS dead letter queue names |
| <a name="output_queue_ids"></a> [queue\_ids](#output\_queue\_ids) | SQS queue ids |
| <a name="output_queue_names"></a> [queue\_names](#output\_queue\_names) | SQS queue names |
